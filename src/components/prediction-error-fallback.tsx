...
export function AIPredictionsFallback() {
              ...
              <DialogContent>
                ...
                <div className="grid gap-4 py-4">
                  <div className="grid grid-cols-4 items-center gap-4">
                    ...
                    <Select value={asset} onValueChange={setAsset} className="col-span-3">
                      <SelectTrigger>
                  ...
                  <div className="grid grid-cols-4 items-center gap-4">
                    ...
                    <Select value={timeframe} onValueChange={setTimeframe} className="col-span-3">
                      <SelectTrigger>
                  ...
                  <div className="grid grid-cols-4 items-center gap-4">
                    ...
                    <div className="col-span-3 space-y-2">
                      <div className="flex items-center space-x-2">
                        <Checkbox id="market-data" checked={useMarketData} onCheckedChange={setUseMarketData} />
